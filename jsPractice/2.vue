<template>
	<view>
		...
		<view class="weather">
			<view>
				<text style="font-size: 25upx;">{{wendu}}</text>
				<image :src="weatherImg" style="width: 60upx; height: 60upx; margin-left: 10upx;"></image>
			</view>
			<view style="font-size: 25upx;">{{type}}&nbsp;&nbsp;{{fengxiang}}{{fengli}}</view>
		</view>
		<view class="header">
			<view class="order">
				<view class="balance-info">
					<view class="left" @click="produceMonitor()">
						<view class="box" style="margin-left: -20upx;">
							<view class="num">
								<text style="font-size: 35upx;">{{companyNum}}</text>
								<text style="font-size: 25upx;">家</text>
							</view>
							<view class="text" style="font-size: 25upx;">企业数量</view>
						</view>
						<view class="box">
							<view class="num">
								<text style="font-size: 35upx;">{{governNum}}</text>
								<text style="font-size: 25upx;">家</text>
							</view>
							<view class="text" style="font-size: 25upx;">治污设施</view>
						</view>
						<view class="box">
							<view class="num">
								<text style="font-size: 35upx;">{{produceNum}}</text>
								<text style="font-size: 25upx;">家</text>
							</view>
							<view class="text" style="font-size: 25upx;">监测产污设施</view>
						</view>
						<view class="box">
							<view class="num">
								<text style="font-size: 35upx;">{{monitorNum}}</text>
								<text style="font-size: 25upx;">家</text>
							</view>
							<view class="text" style="font-size: 25upx;">监测点数量</view>
						</view>
					</view>
				</view>
			</view>
		</view>
		<view class="orders1" style="margin-top: -100upx;">
...
<style lang="scss">
	...
	.orders1 {
		display: flex;
		width: 92%;
		margin: -50rpx auto calc(11vw + 60upx);
